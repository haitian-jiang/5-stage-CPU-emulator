...
void check_and_set(){
    ...
    if inst.a == NOP, the register still can be some meaningful register number
    because the NOP can be set by CPU after detecting the data hazard
